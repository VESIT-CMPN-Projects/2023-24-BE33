...
def detect_emotion(frame, model):
    ...
    for (x, y, w, h) in faces:
        ...
        video_emotions.append(emotion_pred)
...
# Video stream function for uploaded video
def video_stream_file(video_file):
...
def video_feed():
    if 'video_file' in request.files:
        ...
        return Response(video_stream_file(video_file), mimetype='multipart/x-mixed-replace; boundary=frame')
    else:
